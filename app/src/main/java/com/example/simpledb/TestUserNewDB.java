...
@Entity(nameInDb = "UserNew")
public class TestUserNewDB implements Serializable {
    ...
    public TestUserNewDB() {
    }

    public TestUserNewDB(long id, String name, int age, float price, double height, boolean isGood) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.price = price;
    ...
    public TestUserNewDB readEntity(Cursor cursor, int offset) {
        TestUserNewDB entity = new TestUserNewDB(
